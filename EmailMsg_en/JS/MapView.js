...
$(function () {
    ...
    $("#mnu_AddMapPort").click(function (e) {
        ...
        $('#CGEquipmentForMapPort_Add').combogrid({
            ...
            columns: [[
					...
					{ field: 'EquipmentName', title: 'Equipment name', width: 270 }
				]]
        });
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    if (txtMapPortXPos_Add_val == "" || txtMapPortYPos_Add_val == "" || txtMapPortCustomizeName_Add_val == "" || CGEquipmentForMapPort_Add_val == "" || txtMapPortWidth_Add == "" || txtMapPortHeight_Add == "") {
                        $.messager.alert("Infomation", "Please fill in the complete information (coordinates X, Y coordinates, width, height, custom map equipment point name, equipment)", "error");
                        return false;
                    }
                    $.ajax({
                        type: "GET",
    ...
    $("#mnu_UpdateMapPort_Detail").click(function () {
        ...
        if (!bSele) {
            $.messager.alert("Infomation", "Please select the need to modify the equipment", "error");
            return false;
        }
    ...
    $("#mnu_DeleMapPort_Detail").click(function () {
        ...
        if (!bSele) {
            $.messager.alert("Infomation", "Please select the need to remove the equipment", "error");
            return false;
        }
