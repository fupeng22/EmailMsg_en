...
(function ($) {
        ...
        dc.body1.add(dc.body2).unbind().bind("mouseover", function (e) {
            ...
            if (tt.parent().hasClass("datagrid-cell-check")) {
                ...
                if (opts.singleSelect == true) {
                 ...
                 if(td.attr("field")!='printRelease' && td.attr("field")!='HandleException'&& td.attr("field")!='InStoreNum'
                && td.attr("field")!='OutStoreNum'&& td.attr("field")!='InStoreCount'&& 
                td.attr("field")!='OutStoreCount'&& td.attr("field")!='StoreCount' && 
                td.attr("field")!='NotInStoreCount'   && td.attr("field")!='wbTotalNumbe' 
                && td.attr("field")!='ActualWeight' && td.attr("field")!='notReleseNum' &&   td.attr("field")!='TotalRejectSubWayBill' 
                &&  td.attr("field")!='updateFeeRate' &&  td.attr("field")!='printUnReleaseWayBill' && 
                td.attr("field")!='printRejectWayBill' &&  td.attr("field")!='printFirstPickGoods'  && 
                 td.attr("field")!='fOperate'   &&  td.attr("field")!='FinalCheckResultDescription'   && 
                  td.attr("field")!='FinalHandleSuggestDescription'  &&  
                  td.attr("field")!='wbPrintPeronalWayBillList' && td.attr("field")!="TaxValueCheck"  &&  
                  td.attr("field")!="wbTaxFeeConfirmDescription"  && 
                   td.attr("field")!="wbPrintTaxSheet" && td.attr("field")!="PendingSubWayBillCount" &&
                    td.attr("field")!="InStore_Count" && td.attr("field")!="OutStore_Count" && td.attr("field")!="ForeStore_Count" 
                     && td.attr("field")!="RejectNum"  && td.attr("field")!="viewCheckResultForControlWayBill"   && td.attr("field")!="wbSRport_Customize"   && td.attr("field")!="wbArrivalDate_Customize" ){//自己修改
    ...
    $.fn.datagrid.methods = { options: function (jq) {
        ...
        return jq.each(function () {
            $(this).datagrid("clearSelections"); //自己加的
            var opts = $.data(this, "datagrid").options;
