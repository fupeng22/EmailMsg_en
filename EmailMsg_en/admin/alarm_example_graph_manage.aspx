...
<head runat="server">
    <title>Alarm-Example graph setting</title>
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="title_top" align="center">
                <a href="alarm_example_graph_add.aspx">Add</a>
            </td>
        </tr>
    </table>
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" Width="100%" DataKeyNames="cId" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="AlarmTypeName" HeaderText="Alarm description"></asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Operate">
                            <ItemTemplate>
                                <a target="_blank" href='exampleGraphView.aspx?exampleGraphPath=<%#Eval("graphPath")%>'>
                                    View</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href='alarm_example_graph_update.aspx?cId=<%#Eval("cId")%>'>Edit</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
                                        href='del_alarmexamplegraph.aspx?cId=<%#Eval("cId")%>' onclick="javascript:if(confirm('Are you sure you want to delete？')){return true;}else{return false;}">Delete</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
