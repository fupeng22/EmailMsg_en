<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectequipment_manage.aspx.cs"
    Inherits="admin_selectequipment_manage" %>
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30" class="title_top" align="center">
                Screening position equipment information
            </td>
        </tr>
    </table>
    <table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#DFEFFF"
        ...
        <tr>
            <td height="32" style="padding-left: 8px;">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: 9pt">Equipment name</span>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" DataKeyNames="ID" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Operate">
                            <ItemTemplate>
                                <a href='del_selectequipment.aspx?Action=DelSelectEquipment&SelectID=<%#Eval("ID")%>'
