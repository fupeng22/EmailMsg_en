...
<body>
    ...
    <table cellspacing="1" cellpadding="3" width="96%" align="center" bgcolor="#77aeee"
        ...
        <tr>
            ...
            <td bgcolor="#ffffff">
                <asp:Label ID="ShowAlarmID" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td bgcolor="#ffffff">
                <asp:TextBox ID="AlarmTypeName" runat="server" Columns="35" MaxLength="20"></asp:TextBox>
