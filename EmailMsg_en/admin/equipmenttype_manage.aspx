<%@ Page Language="C#" AutoEventWireup="true" CodeFile="equipmenttype_manage.aspx.cs"
    Inherits="admin_equipmenttype_manage" %>
    ...
    <table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#DFEFFF"
        ...
        <tr>
            <td height="32" style="padding-left: 8px;">
                <span style="font-size: 9pt">Device type name</span>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" Width="100%" DataKeyNames="ID" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Device type name" DataField="EquipmentTypeName" />
                        <asp:HyperLinkField HeaderText="Edit" Text="Edit type name" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="equipmenttype_Info.aspx?ID={0}">
                            <ControlStyle Font-Underline="False" ForeColor="Blue" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:HyperLinkField>
                        <asp:TemplateField HeaderText="Operate">
                            <ItemTemplate>
                                <a href='del_equipmenttype.aspx?Action=DelEquipmentType&EquipmentTypeID=<%#Eval("ID")%>'
