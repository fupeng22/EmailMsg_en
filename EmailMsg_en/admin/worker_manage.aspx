...
<head runat="server">
    <title>Personnel information management interface</title>
    ...
    <table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#DFEFFF"
        ...
        <tr>
            <td height="32" style="padding-left: 8px;">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: 9pt">Department name</span>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" Width="100%" DataKeyNames="ID" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Department name" DataField="GroupName" />
                        <asp:BoundField HeaderText="Email" DataField="WorkerEmail" />
                        <asp:HyperLinkField HeaderText="Detail" Text="Detail" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="worker_Info.aspx?ID={0}">
                            <ControlStyle Font-Underline="False" ForeColor="Blue" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:HyperLinkField>
                        <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <a href='del_worker.aspx?Action=DelWorker&WorkerID=<%#Eval("ID")%>' onclick="javascript:if(confirm('Are you sure you want to delete？')){return true;}else{return false;}">
                                    Delete</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
